...
to go
  ask abeilles [moveAbeille]
  ask reines [moveReine]
  tick
end


to moveAbeille
  let nearestReine one-of reines in-radius perception

  ifelse (gotReine = nobody) and (nearestReine != nobody)

  [set gotReine nearestReine]
