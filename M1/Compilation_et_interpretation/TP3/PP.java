...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        ...
        return new UPPLoad(new UPPAdd(narr, new UPPMul(new UPPCte(4), nindex))); // arr + 4*index
    }//toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
	UPPExpr narr = arr.toUPP(locals), nindex = index.toUPP(locals), nval = val.toUPP(locals);
        return new UPPStore(new UPPAdd(narr, new UPPMul(new UPPCte(4), nindex)), nval); // arr + 4*index
    }//toUPP
