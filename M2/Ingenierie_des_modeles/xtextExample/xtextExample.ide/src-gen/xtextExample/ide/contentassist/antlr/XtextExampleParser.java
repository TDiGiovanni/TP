 ...
 */
package xtextExample.ide.contentassist.antlr;
...
import xtextExample.ide.contentassist.antlr.internal.InternalXtextExampleParser;
import xtextExample.services.XtextExampleGrammarAccess;

public class XtextExampleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(XtextExampleGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XtextExampleGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalXtextExampleParser createParser() {
		InternalXtextExampleParser result = new InternalXtextExampleParser(null);
