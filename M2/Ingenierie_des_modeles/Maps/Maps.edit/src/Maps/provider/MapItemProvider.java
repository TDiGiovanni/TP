...
/**
 * This is the item provider adapter for a {@link Maps.Map} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MapsPackage.Literals.MAP__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MapsPackage.Literals.MAP__SPACES);
			childrenFeatures.add(MapsPackage.Literals.MAP__ROADS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MapsPackage.Literals.MAP__SPACES,
				 MapsFactory.eINSTANCE.createGarden()));

		newChildDescriptors.add
			(createChildParameter
				(MapsPackage.Literals.MAP__SPACES,
				 MapsFactory.eINSTANCE.createSquare()));

		newChildDescriptors.add
			(createChildParameter
				(MapsPackage.Literals.MAP__ROADS,
				 MapsFactory.eINSTANCE.createPedestrian()));

		newChildDescriptors.add
			(createChildParameter
				(MapsPackage.Literals.MAP__ROADS,
				 MapsFactory.eINSTANCE.createStreet()));
	}
