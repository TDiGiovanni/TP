...
const char *ssid = "MicroPanda"; /* c'est le SSID : le nom du réseau wifi */
const char *password = "12345678"; /* c'est la clé wifi - minimum 8 caractères */
...
/* On déclare un serveur web dont le port est 80
 *  l'adresse IP de ce serveur sera http://192.168.4.1
 */
ESP8266WebServer server(80);

/****************************************************************************************************/
/* Cette fonction sera exécutée pour répondre à une requête : 192.168.4.1 depuis un navigateur web */ 
void handleRoot()
{
...
/* Cette fonction sera exécutée pour répondre à une requête : 192.168.4.1/ON depuis un navigateur web */
void Allumer()
{
  digitalWrite(2, LOW);
...
/* Cette fonction sera exécutée pour répondre à une requête : 192.168.4.1/OFF depuis un navigateur web */
void Eteindre()
{
  digitalWrite(2, HIGH);
...
/* Fonction de configuration habituelle du langage Arduino */
void setup()
{ 
...
// on peut, bien entendu, ajouter d'autres cas si nécessaire pour réaliser d'autres fonctions
...
/* Boucle habituelle du langage Arduino */
void loop()
{
